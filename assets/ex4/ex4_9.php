...
<div class="login1">   
    ...
    <div class="wrapper">
    <h1>Questão 9<h1>
    Qual o toplaner que levantou os brasileiros no MSI 2020?
    </div>
    <div class="wrapper">
      <input type="radio" name="select"  id="option-1" checked>
      <input type="radio" name="select" id="option-2">
      <input type="radio" name="select" value="1" id="option-3">
    ...
    <div>
    <button class="send" type="submit"><a href="ex4_8.php">➤</a></button>  

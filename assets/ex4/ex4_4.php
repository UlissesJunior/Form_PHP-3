...
<div class="login1">   
    ...
    <div class="wrapper">
    <h1>Questão 4<h1>
    Quem foi o destaque da LBFF 3?
    </div>
    <div class="wrapper">
      <input type="radio" name="select" id="option-1" checked>
      <input type="radio" name="select" id="option-2">
      <input type="radio" name="select" id="option-3">
      <input type="radio" name="select" value="1" id="option-4">
    ...
    <div>
    <button class="send" type="submit"><a href="ex4_3.php">➤</a></button> 

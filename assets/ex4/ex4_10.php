...
<div class="login1">   
    ...
    <div class="wrapper">
    <h1>Questão 10<h1>
    Quem foi o campeão do 1º split do CBLOL em 2021?
    </div>
    <div class="wrapper">
      <input type="radio" name="select" value="1" id="option-1" checked>
    ...
    <div>
    <button class="send" type="submit"><a href="ex4_9.php">➤</a></button>  
...
session_start();
    if(isset($_POST['select'])){
        if($_POST['select'] != '1'){
            header('location: ex4_result.php');
        } else {
            $_SESSION['cont']++;
            header('location: ex4_result.php');
        }   
